...
template<>
void pre_open_hook<libdft_tag_bvector>(syscall_ctx_t *ctx) {
...
template<>
void post_open_hook<libdft_tag_bvector>(syscall_ctx_t *ctx) {
...
#include "hooks/syscall_args.h"
template<>
void post_close_hook<libdft_tag_bvector>(syscall_ctx_t *ctx) {
	/* not successful; optimized branch */
